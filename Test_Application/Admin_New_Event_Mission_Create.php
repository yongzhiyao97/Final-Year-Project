    ...
    <?php 
        ...
        $title = "Admin Create New Event-Based Mission";
                                ...
                                <div class="stepwizard col-md-offset-3" id="mission-step">
                                    ...
                                    <div class="stepwizard-row setup-panel">
                                        ...
                                        <div class="stepwizard-step">
                                            ...
                                            <a :href="event_name && from_date && to_date ? '#step-2':'#'" type="button" class="btn btn-default btn-circle" :style="{ cursor:  event_name && from_date && to_date ? 'pointer':'not-allowed' }" @click="changeDate">2</a>
                                    ...
                                    <div class="row setup-content" id="step-1">
                                        ...
                                        <div class="col-xs-6 col-md-offset-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row" id="event-name-input">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="md-form mt-0">
                                                            ...
                                                            <input type="text" class="form-control" v-model.trim="event_name" maxlength="50" v-focus required pattern="[A-Za-z0-9 ]+" placeholder="Event Name" @change="event_name = event_name.toUpperCase()">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="md-form mt-0">
                                                            ...
                                                            <input type="text" id="from" class="form-control" v-model.trim="from_date" required placeholder="From Date">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="md-form mt-0">
                                                            ...
                                                            <input type="text" id="to" class="form-control" v-model.trim="to_date" required placeholder="To Date">
                                                ...
                                                <button class="btn btn-primary nextBtn btn-lg pull-right" type="button" v-show="event_name && from_date && to_date" @click="changeDate">Next</button>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr v-for = "(mission, index) in missions">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <select class="custom-select my-1" v-model.trim="mission.Range_Date">
        ...
        <script>
            ...
            const vm = new Vue({
                ...
                data: {
                    ...
                    missions: [
                        { Name: '', Requirement: 1, Range_Date: '', Start_Time: null,  End_Time: null, Location: '', Point: 5 },
                        { Name: '', Requirement: 1, Range_Date: '', Start_Time: null,  End_Time: null, Location: '', Point: 5 }
                    ],
                    event_name: null,
                    from_date: null,
                ...
                methods: {
                    ...
                    submit() {
                        ...
                        let event = db.ref_main_1.child("Event").push({
                            Name: this.event_name.toUpperCase(),
