    ...
    <?php 
        ...
        $title = "Admin Edit General-Based Mission";

        $home_title = "Admin";

        $general_mission_id = GET('general_mission_id');

        if($general_mission_id == null) {
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row" id="general-mission-input">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="row" v-show="mission_RandomDateTime != null">

                                                            <div class="col">

                                                               Current Random Date Time is {{ mission_RandomDateTime != null ? changeDateTimeFormat(mission_RandomDateTime):null }}
        ...
        <script>
            ...
            const vm = new Vue({
                ...
                data: {
                    ...
                    general_mission_id: <?= json_encode($general_mission_id) ?>
                },
                methods: {
                    load() {
                        ...
                        db.ref_main_1.on("child_added", snap => {
                            if(snap.key == "General") {
                                ...
                                if(this.general_mission) {
                                    this.mission_Name = this.general_mission.Name,
                                    this.mission_DateTimeMode = this.general_mission.DateTimeMode,
                                    this.mission_Location = this.general_mission.Location,
                                    this.mission_Point = this.general_mission.Point,
                                    this.mission_RandomDateTime = this.general_mission.RandomDateTime || null
                                }
                            }
                        });
                    ...
                    submit() {
                        ...
                        db.ref_main_1.child("General").child(this.general_mission_id).remove();
